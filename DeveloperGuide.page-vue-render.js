...
with(this){return _c('h4',{attrs:{"id":"steps-to-trigger"}},[_v("Steps to trigger"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#steps-to-trigger","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
...
with(this){return _c('h4',{attrs:{"id":"possible-enhancements"}},[_v("Possible enhancements"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#possible-enhancements","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
...
with(this){return _c('h3',{attrs:{"id":"send-email-directly-feature"}},[_v("Send email directly feature"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#send-email-directly-feature","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('h4',{attrs:{"id":"possible-enhancements-2"}},[_v("Possible enhancements"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#possible-enhancements-2","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("The proposed undo/redo mechanism is facilitated by "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("VersionedCodeConnect")]),_v(". It extends "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("CodeConnect")]),_v(" with an undo/redo\nhistory, stored internally as "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("codeConnectStateList")]),_v(" and "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("currentStatePointer")]),_v(". Additionally, it implements the\nfollowing operations:")])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("VersionedCodeConnect#commit()")]),_v(" — Saves the current address book state in its history.")]),_v(" "),_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("VersionedCodeConnect#undo()")]),_v(" — Restores the previous address book state from its history.")]),_v(" "),_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("VersionedCodeConnect#redo()")]),_v(" — Restores a previously undone address book state from its history.")])])}
},function anonymous(
) {
with(this){return _c('p',[_v("These operations are exposed in the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model")]),_v(" interface as "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model#commitCodeConnect()")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model#undoCodeConnect()")]),_v("\nand "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model#redoCodeConnect()")]),_v(" respectively.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("Step 1. The user launches the application for the first time. The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("VersionedCodeConnect")]),_v(" will be initialized with the\ninitial address book state, and the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("currentStatePointer")]),_v(" pointing to that single address book state.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("Step 2. The user executes "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete 5")]),_v(" command to delete the 5th contact in the address book. The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete")]),_v(" command\ncalls "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model#commitCodeConnect()")]),_v(", causing the modified state of the address book after the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete 5")]),_v(" command executes\nto be saved in the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("codeConnectStateList")]),_v(", and the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("currentStatePointer")]),_v(" is shifted to the newly inserted address book\nstate.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("Step 3. The user executes "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add n/David …​")]),_v(" to add a new contact. The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add")]),_v(" command also\ncalls "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model#commitCodeConnect()")]),_v(", causing another modified address book state to be saved into\nthe "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("codeConnectStateList")]),_v(".")])}
},function anonymous(
) {
with(this){return _c('p',[_v("Step 4. The user now decides that adding the contact was a mistake, and decides to undo that action by executing\nthe "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("undo")]),_v(" command. The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("undo")]),_v(" command will call "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model#undoCodeConnect()")]),_v(", which will shift the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("currentStatePointer")]),_v("\nonce to the left, pointing it to the previous address book state, and restores the address book to that state.")])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("redo")]),_v(" command does the opposite — it calls "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model#redoCodeConnect()")]),_v(", which shifts the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("currentStatePointer")]),_v(" once to the right, pointing to the previously undone state, and restores the address book to that state.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("Step 5. The user then decides to execute the command "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("list")]),_v(". Commands that do not modify the address book, such\nas "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("list")]),_v(", will usually not call "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model#commitCodeConnect()")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model#undoCodeConnect()")]),_v(" or "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model#redoCodeConnect()")]),_v(".\nThus, the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("codeConnectStateList")]),_v(" remains unchanged.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("Step 6. The user executes "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("clear")]),_v(", which calls "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model#commitCodeConnect()")]),_v(". Since the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("currentStatePointer")]),_v(" is not\npointing at the end of the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("codeConnectStateList")]),_v(", all address book states after the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("currentStatePointer")]),_v(" will be\npurged. Reason: It no longer makes sense to redo the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add n/David …​")]),_v(" command. This is the behavior that most modern\ndesktop applications follow.")])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_v("keep track of other student developers")]),_v(" "),_c('li',[_v("reach out easily to those with relevant skills for collaboration opportunities.")])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("User requests to delete a specific contact in his list of contacts.")]),_v(" "),_c('li',[_v("CodeConnect deletes the contact.\nUse case ends.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. The list is empty.")]),_v(" "),_c('ul',[_c('li',[_v("1a1. CodeConnect shows an error message.\nUse case ends.")])])]),_v(" "),_c('li',[_c('p',[_v("1b. The given index does not exist in CodeConnect.")]),_v(" "),_c('ul',[_c('li',[_v("1b1. CodeConnect shows an error message.\nUse case ends.")])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("User requests to add a Student’s contact information into his list of contacts.")]),_v(" "),_c('li',[_v("CodeConnect saves the new contact and displays it at the top of the contact list.\nUse case ends.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. The contact already exists in the system.")]),_v(" "),_c('ul',[_c('li',[_v("1a1. CodeConnect shows an error message.\nUse case ends.")])])]),_v(" "),_c('li',[_c('p',[_v("1b. No fields are entered.")]),_v(" "),_c('ul',[_c('li',[_v("1b1. CodeConnect shows an error message.\nUse case ends.")])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("User requests to update a Student’s contact information into his list of contacts.")]),_v(" "),_c('li',[_v("CodeConnect updates the contact.\nUse case ends.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. The given index to identify contact is invalid.")]),_v(" "),_c('ul',[_c('li',[_v("1a1. CodeConnect shows an error message.\nUse case ends.")])])]),_v(" "),_c('li',[_c('p',[_v("1b. No fields are entered.")]),_v(" "),_c('ul',[_c('li',[_v("1b1. CodeConnect shows an error message.\nUse case ends.")])])]),_v(" "),_c('li',[_c('p',[_v("1c. Updated value does not follow format of the specific field.")]),_v(" "),_c('ul',[_c('li',[_v("1b1. CodeConnect shows an error message.\nUse case ends.")])])]),_v(" "),_c('li',[_c('p',[_v("1d. Updated contact matches another existing contact")]),_v(" "),_c('ul',[_c('li',[_v("1b1. CodeConnect shows an error message.\nUse case ends.")])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("User requests to view all his contacts.")]),_v(" "),_c('li',[_v("CodeConnect displays all contacts.\nUse case ends.")])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to look up contacts with a specific substring in their name.")])]),_v(" "),_c('li',[_c('p',[_v("CodeConnect checks each contact’s name in the list that contains the substring.")])]),_v(" "),_c('li',[_c('p',[_v("CodeConnect shows a list of contacts that match the criteria.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. No substring is given.")]),_v(" "),_c('ul',[_c('li',[_v("1a1. CodeConnect shows an error message.\nUse case ends.")])])]),_v(" "),_c('li',[_c('p',[_v("1b. There are no contacts in the list that match the criteria.")]),_v(" "),_c('ul',[_c('li',[_v("1b1. CodeConnect shows an empty list.\nUse case ends.")])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to look up contacts with specific tags.")])]),_v(" "),_c('li',[_c('p',[_v("CodeConnect checks each contact’s tags in the list.")])]),_v(" "),_c('li',[_c('p',[_v("CodeConnect shows a list of contacts that match the criteria.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. No tag is given.")]),_v(" "),_c('ul',[_c('li',[_v("1a1. CodeConnect shows an error message.\nUse case ends.")])])]),_v(" "),_c('li',[_c('p',[_v("1b. There are no contacts in the list that match the criteria.")]),_v(" "),_c('ul',[_c('li',[_v("1b1. CodeConnect shows an empty list.\nUse case ends.")])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to look up contacts with specific tech stack.")])]),_v(" "),_c('li',[_c('p',[_v("CodeConnect checks each contact’s tech stack in the list.")])]),_v(" "),_c('li',[_c('p',[_v("CodeConnect shows a list of contacts that match the criteria.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. No tech stack is given.")]),_v(" "),_c('ul',[_c('li',[_v("1a1. CodeConnect shows an error message.\nUse case ends.")])])]),_v(" "),_c('li',[_c('p',[_v("1b. There are no contacts in the list that match the criteria.")]),_v(" "),_c('ul',[_c('li',[_v("1b1. CodeConnect shows an empty list.\nUse case ends.")])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: UC08 - Sending an email to a specific contact")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User clicks on the email address of a specific contact.")])]),_v(" "),_c('li',[_c('p',[_v("CodeConnect detects the user action and retrieves the email address associated with the clicked contact.")])]),_v(" "),_c('li',[_c('p',[_v("CodeConnect opens the default desktop mail application.")])]),_v(" "),_c('li',[_c('p',[_v("CodeConnect populates the recipient field of the mail application with the retrieved email address.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("1a. The default desktop mail application is not available on the system.\n"),_c('ul',[_c('li',[_c('p',[_v("1a1. CodeConnect displays an error message indicating that the desktop mail application is not supported.")]),_v(" "),_c('p',[_v("Use case ends.")])])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: UC09 - Viewing command history")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User selects command input.")])]),_v(" "),_c('li',[_c('p',[_v("User requests to view previous or next command in history.")])]),_v(" "),_c('li',[_c('p',[_v("CodeConnect retrieves the command from the command history.")])]),_v(" "),_c('li',[_c('p',[_v("CodeConnect updates the contents of the command input.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("3a. CodeConnect does not find any previous/next command in the command history.\nUse case ends.")])])}
},function anonymous(
) {
...
with(this){return _c('li',[_c('strong',[_v("Mainstream OS")]),_v(": Windows, Linux, Unix, MacOS")])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.3.0")]),_v(", generated on Fri, 22 Mar 2024, 23:34:35 GMT+8]")])])])}
}];
